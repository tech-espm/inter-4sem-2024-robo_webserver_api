...
var app = (function () {
    ...
    /* src\BarChart.svelte generated by Svelte v3.59.2 */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			svg = svg_element("svg");
    			attr_dev(svg, "class", "svelte-12io37o");
    			add_location(svg, file$4, 52, 0, 1549);
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		const svg = select(chart).attr("width", width).attr("height", height).append("g").attr("transform", `translate(${margin.left},${margin.top})`);
    		const x = band().domain(range$2(data.length)).range([0, width - margin.left - margin.right]).padding(0.1);
    		const y = linear().domain([0, max$3(data)]).range([height - margin.top - margin.bottom, 0]);

    		// Eixos
    		svg.append("g").attr("transform", `translate(0,${height - margin.top - margin.bottom})`).call(axisBottom(x).tickFormat(i => i + 1).tickSizeOuter(0));

    		svg.append("g").call(axisLeft(y));

    		// Barras
    		svg.selectAll("rect").data(data).enter().append("rect").attr("x", (d, i) => x(i)).attr("y", d => y(0)).attr("width", x.bandwidth()).attr("height", 0).attr("fill", "#ff6600").transition().duration(800).attr("y", d => y(d)).attr("height", d => y(0) - y(d));
    	});
    ...
    const file$3 = "src\\LineChart.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			svg = svg_element("svg");
    			attr_dev(svg, "class", "svelte-1fft9vn");
    			add_location(svg, file$3, 57, 0, 1814);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		const svg = select(chart).attr("width", width).attr("height", height).append("g").attr("transform", `translate(${margin.left},${margin.top})`);
    		const x = linear().domain([min$2(lineData, d => d.year), max$3(lineData, d => d.year)]).range([0, width - margin.left - margin.right]);
    		const y = linear().domain([0, max$3(lineData, d => d.value)]).range([height - margin.top - margin.bottom, 0]);
    		const line$1 = line().x(d => x(d.year)).y(d => y(d.value));
    		svg.append("g").attr("transform", `translate(0,${height - margin.top - margin.bottom})`).call(axisBottom(x).ticks(5).tickFormat(format("d")));
    		svg.append("g").call(axisLeft(y));

    		// Linha
    		svg.append("path").datum(lineData).attr("fill", "none").attr("stroke", "#ff6600").attr("stroke-width", 2).attr("d", line$1).attr("stroke-dasharray", function () {
    	...
    	$$self.$$set = $$props => {
    		if ('lineData' in $$props) $$invalidate(1, lineData = $$props.lineData);
    	};
    	...
    	return [chart, lineData, svg_binding];
    }

    class LineChart extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$3, create_fragment$3, safe_not_equal, { lineData: 1 });
    ...
    /* src\PieChart.svelte generated by Svelte v3.59.2 */
    const file$2 = "src\\PieChart.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			svg = svg_element("svg");
    			attr_dev(svg, "class", "svelte-1fft9vn");
    			add_location(svg, file$2, 45, 0, 1229);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		const svg = select(chart).attr("width", width).attr("height", height).append("g").attr("transform", `translate(${width / 2},${height / 2})`);
    		const color = ordinal().domain(pieData.map(d => d.crop)).range(category10);
    		const pie$1 = pie().value(d => d.value).sort(null);
    		const arc$1 = arc().innerRadius(0).outerRadius(radius);

    		svg.selectAll("path").data(pie$1(pieData)).enter().append("path").attr("d", arc$1).attr("fill", d => color(d.data.crop)).transition().duration(1000).attrTween("d", function (d) {
    			const i = interpolate$2({ startAngle: 0, endAngle: 0 }, d);
    			return t => arc$1(i(t));
    		});
    	});

    	const writable_props = ['pieData'];
    	...
    	$$self.$$set = $$props => {
    		if ('pieData' in $$props) $$invalidate(1, pieData = $$props.pieData);
    	};
    	...
    	return [chart, pieData, svg_binding];
    }

    class PieChart extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$2, create_fragment$2, safe_not_equal, { pieData: 1 });
    ...
    /* src\ScatterPlot.svelte generated by Svelte v3.59.2 */
    const file$1 = "src\\ScatterPlot.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			svg = svg_element("svg");
    			attr_dev(svg, "class", "svelte-1vqkv3i");
    			add_location(svg, file$1, 47, 0, 1451);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		...
    		const x = linear().domain([
    			min$2(scatterData, d => d.temperature),
    			max$3(scatterData, d => d.temperature)
    		]).range([0, width - margin.left - margin.right]);

    		const y = linear().domain([0, max$3(scatterData, d => d.production)]).range([height - margin.top - margin.bottom, 0]);
    		svg.append("g").attr("transform", `translate(0,${height - margin.top - margin.bottom})`).call(axisBottom(x));
    		svg.append("g").call(axisLeft(y));
    		svg.selectAll("circle").data(scatterData).enter().append("circle").attr("cx", d => x(d.temperature)).attr("cy", d => y(d.production)).attr("r", 0).attr("fill", "#ff6600").transition().duration(1000).attr("r", 6);
    	});

    	const writable_props = ['scatterData'];
    	...
    	$$self.$$set = $$props => {
    		if ('scatterData' in $$props) $$invalidate(1, scatterData = $$props.scatterData);
    	};
    	...
    	return [chart, scatterData, svg_binding];
    }

    class ScatterPlot extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$1, create_fragment$1, safe_not_equal, { scatterData: 1 });
    ...
    function create_fragment(ctx) {
    	...
    	barchart = new BarChart({
    			props: { barData: /*barData*/ ctx[0] },
    			$$inline: true
    		});

    	linechart = new LineChart({
    			props: { lineData: /*lineData*/ ctx[1] },
    			$$inline: true
    		});

    	piechart = new PieChart({
    			props: { pieData: /*pieData*/ ctx[2] },
    			$$inline: true
    		});

    	scatterplot = new ScatterPlot({
    			props: { scatterData: /*scatterData*/ ctx[3] },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			h20 = element("h2");
    			h20.textContent = "Produção por Tipo de Cultivo";
    			t3 = space();
    			create_component(barchart.$$.fragment);
    			t4 = space();
    			h21 = element("h2");
    			h21.textContent = "Produtividade ao Longo dos Anos";
    			t6 = space();
    			create_component(linechart.$$.fragment);
    			t7 = space();
    			h22 = element("h2");
    			h22.textContent = "Proporção de Cultivos";
    			t9 = space();
    			create_component(piechart.$$.fragment);
    			t10 = space();
    			h23 = element("h2");
    			h23.textContent = "Correlação Temperatura x Produção";
    			t12 = space();
    			create_component(scatterplot.$$.fragment);
    			attr_dev(h1, "class", "svelte-14zn1cw");
    			add_location(h1, file, 30, 1, 895);
    			attr_dev(h20, "class", "svelte-14zn1cw");
    			add_location(h20, file, 32, 4, 923);
    			attr_dev(h21, "class", "svelte-14zn1cw");
    			add_location(h21, file, 35, 4, 993);
    			attr_dev(h22, "class", "svelte-14zn1cw");
    			add_location(h22, file, 38, 4, 1068);
    			attr_dev(h23, "class", "svelte-14zn1cw");
    			add_location(h23, file, 41, 4, 1131);
    			attr_dev(main, "class", "svelte-14zn1cw");
    			add_location(main, file, 29, 0, 887);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, h21);
    			append_dev(main, t6);
    			mount_component(linechart, main, null);
    			append_dev(main, t7);
    			append_dev(main, h22);
    			append_dev(main, t9);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let pieData = [
    		...
    		{ crop: "Soja", value: 30 },
    		{ crop: "Trigo", value: 20 },
    		{ crop: "Algodão", value: 10 }
    	];

    	let scatterData = [
    		{ temperature: 20, production: 50 },
    		{ temperature: 25, production: 80 },
    		{ temperature: 30, production: 60 },
    		{ temperature: 35, production: 100 },
    		{ temperature: 40, production: 90 }
    	];
    	...
    	$$self.$inject_state = $$props => {
    		if ('barData' in $$props) $$invalidate(0, barData = $$props.barData);
    		if ('lineData' in $$props) $$invalidate(1, lineData = $$props.lineData);
    		if ('pieData' in $$props) $$invalidate(2, pieData = $$props.pieData);
    		if ('scatterData' in $$props) $$invalidate(3, scatterData = $$props.scatterData);
    	};
    	...
    	return [barData, lineData, pieData, scatterData];
    }
